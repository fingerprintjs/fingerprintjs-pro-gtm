...

{
  ...
  "description": "This template adds FingerprintJS Pro agent, the highest accuracy device identification. Visit https://fingerprint.com/ for more information and get you public API key.",
  "containerContexts": [
    "WEB"
  ]
}
